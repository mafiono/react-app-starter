...
import {
	Help, SignUp, Home, Casino, Profile, Cashier, LiveCasino,
	VirtualSports, Vip, BlogNews, Promotions, NotFound, AboutUs,
	Affiliates, PasswordRecovery, Logout, Search, ResetPassword, ConfirmSignUp
} from './container';
import { Login, Header, Footer, SwipeableMenu, GameOverlay, Notification } from './component';
...
class App extends React.Component {
	...
	constructor(props) {
		...
		const muiTheme = props.muiTheme || createTheme(deepmerge(
					...
					<AppWrapper>
						...
						<ContentWrapper>
							...
							<Switch>
								...
								<Route path="/live-casino/:providerId?" component={LiveCasino} />
